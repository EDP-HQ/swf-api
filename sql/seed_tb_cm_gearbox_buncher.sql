...
INSERT INTO dbo.TB_CM_GEARBOX_ASSET
    (COMPANY, FACTORY, GEARBOX_ID, GEARBOX_NM, PROCESS_CD, LINE_CD, STATUS, LIFETIME_RUNTIME_SEC, CREATED_DT)
SELECT @Company, @Factory, i.GEARBOX_ID,
       N'Gearbox ' + RIGHT(i.GEARBOX_ID, 2),
       @ProcessCd, @LineCd, 'SPARE', 0, GETDATE()
FROM ids i
WHERE NOT EXISTS (
    SELECT 1
