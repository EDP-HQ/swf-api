...
BEGIN
    ...
    SELECT
        ...
        cm.MACHINE_CD,
        ISNULL(cm.LINE_YN, N'N') AS LINE_YN
    ...
    ORDER BY cm.PROCESS_CD, cm.LINE_CD, CASE WHEN ISNULL(cm.LINE_YN, N'N') = N'Y' THEN 0 ELSE 1 END, cm.MACHINE_NM;
END;
GO
